...
{
	public class UnionConfig : DataConfig<Union>
	{
		public override string Path => "SSC/unions.json";

		public override string Message => GameLanguage.GetText("unionconfigcreate");

		public override Dictionary<string, Union> Get()
		{
			return ServerSideCharacter2.UnionManager.Unions;
		}
